...
app = cdk.App()
AmazonEventBridgeFilteringRuleToTriggerLambdaStack(app, "AmazonEventBridgeFilteringRuleToTriggerLambdaStack",
    ...
    # env=cdk.Environment(account='61983122155', region='eu-central-1'),
